...
/*
 *
 * 路由模式  消费者，将会监听消费指定路由的队列
 * */
public class Consumer3_routing_Email2 {
    private static final String QUEUE_INFORM_EMAIL = "queue_inform_email2";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //交换机和队列绑定,指明route-key，将路由key和队列绑定
